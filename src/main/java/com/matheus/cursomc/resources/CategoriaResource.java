...
public class CategoriaResource {
    ...
    public ResponseEntity<Void> insert(@Valid @PathVariable Integer id, @RequestBody CategoriaDTO objDTO) {
        Categoria obj = service.fromDTO(objDTO);
        obj.setId(id);
    ...
    public ResponseEntity<Page<CategoriaDTO>> findPage(
        ...
        Page<CategoriaDTO> result = pages.map(obj -> new CategoriaDTO(obj));
        return ResponseEntity.ok().body(result);
    }
}
